...
void TrafficLight::cycleThroughPhases()
{
    ...
    while(true)
    {
        auto duration = std::chrono::duration_cast<std::chrono::seconds>(std::chrono::system_clock::now() - stopwatch).count();
          ...
          std::async(std::launch::async, &MessageQueue<TrafficLightPhase>::send, &_messages, std::move(_currentPhase));
